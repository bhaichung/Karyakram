 ...
 * @author acer
 */
public class locService extends javax.swing.JFrame {

    /**
     * Creates new form locService
     */
    public locService() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setMinimumSize(new java.awt.Dimension(1320, 702));
        setPreferredSize(new java.awt.Dimension(1308, 702));

        jPanel1.setPreferredSize(new java.awt.Dimension(1310, 702));
        jPanel1.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/view/Group 22.png"))); // NOI18N
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 50, -1, 620));

        jLabel4.setFont(new java.awt.Font("Segoe UI", 1, 52)); // NOI18N
        jLabel4.setText("Find the best");
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 50, 346, 73));

        jLabel5.setFont(new java.awt.Font("Segoe UI", 1, 52)); // NOI18N
        jLabel5.setText("location near");
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 120, 346, 73));

        jLabel6.setFont(new java.awt.Font("Segoe UI", 1, 52)); // NOI18N
        jLabel6.setText("KTM");
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 180, 120, 73));
        ...
        jPanel1.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 260, -1, -1));
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 510, -1, 70));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(locService.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
